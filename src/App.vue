  ...
  <div :id="$style.app">
    ...
    <ApartmentsList v-bind:items="apartments">
      ...
      <template v-slot:apartment="{ apartment }">
        <ApartmentsItem v-bind:key="apartment.id" v-bind:descr="apartment.descr" v-bind:rating="apartment.rating"
          v-bind:imgSrc="apartment.imgUrl" v-bind:price="apartment.price" @click.native="handleItemClick">
        </ApartmentsItem>
      </template>
    </ApartmentsList>
  </div>
